...
variable "kubespray_url" {default = "https://github.com/cablelabs/kubespray"}
variable "kubespray_branch" {default = "master"}
variable "k8s_version" {default = "1.12.5"}
variable "k8s_dflt_networking_plugin" {default = "contiv"}
