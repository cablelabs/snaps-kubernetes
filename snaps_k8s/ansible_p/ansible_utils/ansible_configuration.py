...
###### Authentication configuration end ######### 
 if enable_istio=="yes":
  ...
  ret_hosts=ansible_playbook_launcher.__launch_ansible_playbook_istio(playbook_path_setup_istio,consts.K8_INVENTORY_CFG,PROXY_DATA_FILE)
  if(ret_hosts!=True):
 ...
 if enable_ambassador=="yes":
  ...
  ret_hosts=ansible_playbook_launcher.__launch_ansible_playbook_ambassador(playbook_path_setup_ambassador,consts.K8_INVENTORY_CFG,PROXY_DATA_FILE,ambassador_rbac)
  if(ret_hosts!=True):
